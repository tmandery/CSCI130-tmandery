...
//  Updated by: Tristan Mandery    FIXED#1
//  Date: 3/28/24   FIXED#2
...
int main(int argc, char* argv[]) {
    ...
    large_int *larg = new large_int;    //FIXED3
...
big_int MyFunctions::findLarger(const big_int *n1, const big_int *n2) {  //FIXED8
    return *n1 > *n2 ? *n1 : *n2;
}
